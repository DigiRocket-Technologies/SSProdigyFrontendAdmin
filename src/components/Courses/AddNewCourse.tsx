// const handleModularChange = (index, value) => {
...
// const CourseForm = ({ onSubmit, initialData = null }) => {
...
//               />
//               <label htmlFor="liveStatus" className="text-white font-semibold">
//                 Live Course Status
//               </label>
//             </div>
